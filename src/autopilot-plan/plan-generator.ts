...
function buildPlanPrompt(mission: AutopilotPlanMission, inventory: RepoInventory): string {
  ...
  return [
    ...
    'Explicit file paths named by the operator in the mission goal are immutable requirements.',
    ...
    'The system will NOT hard-reject a change for exceeding this budget; the coder should still prefer minimal changes and include a note if the budget cannot be met without compromising correctness.',
